<?php
    ...
    if(isset($_POST['save'])){ 
        ...
        if(in_array($resumetype, $allowTypes))
        {
            ...
            {
              $sql1="UPDATE category SET categoryname = '$name', categoryimage = '$resumename' WHERE `id` = '$id'";
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <label class="col-form-label">Category Name </label>
                            <input class="input-group-text" type="text" name="name" value="<?php echo $row['categoryname'];?>" >
                        </div>
                        <div class="col-xxl-6 col-md-6">
                        ...
                        <div class="col-xxl-6 col-md-6">
                        <img src="<?php $src=$row['categoryimage']; echo $src; ?> " width="75px" height="75px">
                        </div>
