<?php
    ...
    $sql = "SELECT * FROM jobtype WHERE id='$id'";
    ...
    if(isset($_POST['save'])){ 
        ...
        //     {
              $sql1="UPDATE jobtype SET type = '$name' WHERE `id` = '$id'";
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <label class="col-form-label">Location Name </label>
                            <input class="input-group-text" type="text" name="name" value="<?php echo $row['type'];?>" >
                        </div>
