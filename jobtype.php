<?php 
	...
	$name = $_POST['name'];
		...
		$sql = "INSERT INTO jobtype(type) VALUES ('$name')";
							...
							<thead>
								<tr>
									<th scope="col" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">S.NO</th>
                  					<th scope="col" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Job Type</th>
									<th scope="col" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Action</th>
								</tr>
							</thead>
							<tbody>
									<?php 
									$sql1 = "SELECT * FROM jobtype";
									$result = $conn->query($sql1);
									$i=1;
									while($row=$result->fetch_assoc()){
										$category_id = $row['location'];
									...
									<tr>
										...
										<td>
											<a href="edit_jobtype.php?id=<?php echo $row['id'] ?>">
											<button type="button" class="btn btn-success">
												Edit
											</button>
											</a> 
											<a href="delete_jobtype.php?id=<?php echo $row['id'] ?>">
