...
<body>
	...
	<main id="main" class="main">
		...
		<section class="section profile">
			<?php
			$sql = "SELECT * FROM applies WHERE jobid = '$jobid'";
			$result = $conn->query($sql);
			$i = 1;
			while ($row = $result->fetch_assoc()) {
				$seeker1 = $row['seekerid'];
				$aplyid = $row['id'];
			?>
				<div class="col-xl-12">
					<div class="card">
						<div class="card-body profile-card pt-4 d-flex flex-column">
							<?php
							$sql2 = "SELECT * FROM jobseeker WHERE id = '$seeker1'";
							$result2 = $conn->query($sql2);
							$row2 = $result2->fetch_assoc();

							$sql3 = "SELECT * FROM company_new_job WHERE id = '$jobid' ";
							...
							<div class="row">
								<div class=" col-3 align-items-center d-flex ">
									...
									<h2> <?php echo  $jobid2; ?></h2>
								</div>
								<div class="col-6 align-items-center d-flex ">
									<a href="seeker_view_profile.php?id=<?php echo $seeker1 ."&aplyid=".$aplyid ."&cid=$cid" ?>">
										<img src="<?php echo $row2['photo']; ?>" alt="Profile" style="height: 30px; width: 50px" class="rounded-circle">	
										<h2><?php echo $row2['name']; ?></h2>
									</a></div>
								<div class="col-3 align-items-center d-flex text-color-primary">
