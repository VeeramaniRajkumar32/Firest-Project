                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <label class="col-form-label">Add Skills </label>
                            <input class="input-group-text" type="text" name="skills" >
                        </div>
							...
							<thead>
								<tr>
									<th scope="col" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">S.NO</th>
                  					<th scope="col" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Skills</th>
