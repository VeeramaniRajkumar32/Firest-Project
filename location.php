<?php 
	...
	$name = $_POST['name'];
		...
		$sql = "INSERT INTO location(locationname) VALUES ('$name')";
						...
						<table class="table datatable" >
							<thead>
								<tr>
									<th scope="col" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">S.NO</th>
                  					<th scope="col" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Location Name</th>
							...
							<tbody>
									...
									<tr>
										...
										<td>
											<a href="edit_location.php?id=<?php echo $row['id'] ?>">
